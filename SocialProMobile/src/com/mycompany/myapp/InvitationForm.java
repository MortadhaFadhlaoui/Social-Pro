 ...
 * @author ASUS
 */
public class InvitationForm extends BaseForm {
    ...
    public InvitationForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Mes invitations", "Title")
                )
        );
    ...
    private void initGuiBuilderComponents(Resources resourceObjectInstance) {
        ...
        con.setUrl("http://localhost/SocialPro1/selectEvenement.php");
                ...
                for (Evenement u : getListEvents(new String(con.getResponseData()))) {
                    ...
                    m.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent evt) {
                            ...
                            if (Dialog.show("Confirm", "vous etes invité à cet evenement vous voulez  ?", "participer", "refuser")) {

                                ConnectionRequest req = new ConnectionRequest();
                                req.setUrl("http://localhost/SocialPro1/insertParticip.php?id_evenement=" + id + "&id_user=" + Context.getInstance().getUser().getId());
                                req.addResponseListener(new ActionListener<NetworkEvent>() {
                                    ...
                                    public void actionPerformed(NetworkEvent evt) {
                                        ...
                                        if (s.equals("success")) {
                                            Dialog.show("Confirmation", "vous avez participer à cette evenement", "Ok", null);
