/**
 * Created by Mortadhafff on 27/03/2017.
 */
$(document).ready(function(){
    ...
    $("#belousovFormZone form textarea").focus(function(){
        if($(this).val() == "Send message..."){
            $(this).val("");
        }
    });
    $("#belousovFormZone form textarea").focusout(function(){
        if($(this).val() == ""){
