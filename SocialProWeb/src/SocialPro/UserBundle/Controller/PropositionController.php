...
class PropositionController extends Controller
{
    public function listAction(Request $request)
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
            ...
            return $this->render("SocialProUserBundle:Proposition:proposition.html.twig",array('props'=>$comp,'vp'=>$vp,'vc'=>$vc,'user'=>$user));
        }
    ...
    public function pourAction(Request $request,$id)
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
            ...
            return new RedirectResponse($router->generate('propositionn'), 307);
        }
        elseif ($authChecker->isGranted('ROLE_USER')) {
            return new RedirectResponse($router->generate('social_pro_user_homepage'), 307);
        }
    ...
    public function pdfAction()
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
            ...
            $html = $this->renderView("SocialProUserBundle:Proposition:proposition.html.twig",array('props'=>$comp,'vp'=>$vp,'vc'=>$vc,'user'=>$user));
    ...
    public function DeletePropositionAction($id)
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
            ...
            $em->remove($prop);
            $em->flush();
            return new RedirectResponse($router->generate('propositionn'));
    ...
    public function CommentPropositionAction($id)
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
          ...
          //  var_dump($profil[0]->getImageName());
           return $this->render("SocialProUserBundle:Proposition:comment.html.twig",array('propcom'=>$propcom,'propuser'=>$propuser,'comprop'=>$comprop));
        }
        elseif ($authChecker->isGranted('ROLE_USER')) {
            return new RedirectResponse($router->generate('social_pro_user_homepage'), 307);
        }
    ...
    public function AddCommentAction(Request $request)
    {
        ...
        if ($authChecker->isGranted('ROLE_USER')) {
            ...
            $user = $this->getUser();
                ...
                $em->persist($prop);
                $em->flush();
            return new RedirectResponse($router->generate('CommentPropositionnn',array('id'=>$id)));
        }
        elseif ($authChecker->isGranted('ROLE_USER')) {
            return new RedirectResponse($router->generate('social_pro_user_homepage'), 307);
        }
